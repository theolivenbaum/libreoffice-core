...
`iconSet` half is not nil reach and is re-seated as O25 with a corrected census. §6 says which.
...
**O22, `iconSet` — not closed, and re-seated as O25 with a corrected census.** It is neither fixed
