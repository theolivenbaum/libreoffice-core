#!/usr/bin/env python3
"""Fixture B2 -- the same advance channel, over PROPORTIONS other than 58.
...
DIGIT = '0'
N1, N2 = 2, 42
SIZES = [11.0, 13.0, 40.0]
PROPS = [25, 33, 41, 45, 49, 51, 53, 57, 58, 59, 61, 63, 67, 71, 73, 77, 79, 83, 87, 89, 91, 93, 97, 99]
