...
set -uo pipefail
BASE=/home/user/r111-work/base-cli/Paperless.Cli
HEAD=/home/user/wt-slidesfinal/dotnet/tools/Paperless.Cli/bin/Release/net10.0/linux-x64/Paperless.Cli
BANK=/home/user/gate-orig-r83/ref
DIFF=/home/user/wt-slidesfinal/.claude/skills/render-comparison/scripts/pdf-image-diff.py
OUT="$2"
T=/home/user/r111-work/inkt
